...
\textbf{Second ML_INFN hackathon (2021).} I led one of the exercises at the \href{https://agenda.infn.it/event/28565/contributions/148551/}{Second ML_INFN hackathon} (December 13-15, 2021) for six students.The exercise consisted of developing a search for single Higgs events produced via vector boson fusion by using machine learning techniques (Deep Neural Network DNN, Random Forest RF) in final states with four-charged leptons (4mu/4e) in CMS for the 13 TeV Run II data-taking campaign.
