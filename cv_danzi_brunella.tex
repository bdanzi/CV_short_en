...
\textbf{Career goals:} I am a Ph.D. student at University of Bari and INFN - Bari section, in experimental particle physics and my main scientific interests are related to elementary particle physics, and in particular to double Higgs boson studies. I mostly work with data analysis and data science tools, together with computer programming algorithms, in order to extract physics results from data. I am also fascinated by gaseous detector technologies development and in particular by beam tests data-taking.\\
\textbf{Publications:} I am a CMS Collaboration author and the author of 6 publications, which are: 1 proceeding, 1 paper and 1 unofficial paper.\\
...
\textsc{C/C++} $\cdotp$ \textsc{python} $\cdotp$ \LaTeX, \textsc{ROOT} $\cdotp$ \textsc{RooFit}}
\MarginText{Scientific libraries} 
\textsc{numpy} $\cdotp$ \textsc{pandas} $\cdotp$ \textsc{scikit-learn} $\cdotp$ \textsc{tensorflow} $\cdotp$ \textsc{matplotlib}
\MarginText{Operating Systems} 
\textsc{OSX} $\cdotp$ \textsc{Windows}
...
\MarginText{Other Information}\vspace{.5em}
...
\textsc{Italian} (Mother tongue) $\cdotp$  \textsc{English} (Fluent) $\cdotp$ \textsc{French} (Basic)
...
\MarginText{Interests} Reading $\cdotp$ Violin  $\cdotp$ Piano $\cdotp$ Viola
