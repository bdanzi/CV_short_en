...
\textbf{University of Bari, Seminar to Physics Master's degree students.} \textbf{(\textit{March 2021})}\\ \href{https://recascloud.ba.infn.it/index.php/s/ItcCFRRq3gKGuXx}{\textit{"The Top Quark discovery at the Fermilab Tevatron collider" seminar}}\\ %during the \textit{Elementary Particle Physics} course for first year Master students in Particle, Astroparticle Physics and Advanced Technologies\\
