...
\tikzset{
  linkedinlogo/.pic={
    % Background circle
    \fill[linkedinblue] circle (0.5*\linewidth);
    % InLogo "in" part
    \fill[white] ($(0.45*\linewidth,0.35*\linewidth) + (0,0.15*\linewidth)$) to[out=0, in=160] ($(0.45*\linewidth,0.35*\linewidth) + (0,0.05*\linewidth)$) to[out=200, in=20] cycle;
    % InLogo "i" part
    \fill[linkedinblue] ($(0.45*\linewidth,0.35*\linewidth) + (0,0.1*\linewidth)$) circle (0.05*\linewidth);
  }
}
