...
\textbf{Advanced techniques for track reconstruction and search for non-resonant production of double Higgs bosons decaying into muon pairs and two b-jets in pp collisions with the CMS experiment at the LHC}\\
\textbf{Summary:} I am developing the extension of tracking algorithms to additional subdetectors at CMS using etherogenues architectures (GPU,CPU), I am using Deep Learning to search for maximum peaks in wave spectra and I am currently using supervised Machine Learning algorithms to increase the sensitivity to double Higgs signals. Working on using the state-of-the-art tagging Deep Learning technologies (ParT,ParticleNet) for a better b-jets identification.\\
...
\textbf{CERN Doctoral Student: Tracking efficiency performance evaluation using the data-driven Tag and Probe technique (\textit{April 2022--Present}) | CERN}\\
...
\textbf{CERN Doctoral Student: Beam Tests Data Analysis for Cluster counting particle identification technique \textbf{(\textit{Jan 2022--Present})}.} 
...
\textbf{Lead Contact for Tracking, Muon tutorials at \textit{CMS Data Analysis Schools 2023} (\textit{Jan 2023} and \textit{June 2023} | Fermilab, Chicago (US) and CERN)}\\
