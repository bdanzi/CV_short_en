...
\textbf{HEP and Machine learning/Double Higgs searches at the CMS experiment.} Development of Machine Learning algorithms (Neural Network and Decision Tree-based) to identify a pair of Higgs bosons decaying to two muons/Z bosons to four charged leptons and two b-jets at the CMS experiment \textbf{(\textit{2021--Present})}

\textbf{HEP/CMS Tracking efficiency using the Tag and Probe technique.} Measurement of the Tracking efficiency in the CMS experiment using high statistics resonances (Z boson, J/Psi) decaying to two muons, imposing tight requirements to the one (Tag) reconstructed by both CMS Tracker and Muon systems, and loose constraints to the one (Probe) used to check if there is a match of its track in the CMS Tracker system.\textbf{(\textit{March 2022--Present})}
