...
\textsc{OSX} -- \textsc{Windows} -- \textsc{bash} -- \textsc{C/C++} -- \textsc{Python3/2} -- \textsc{ROOT} -- \textsc{Numpy} -- \textsc{Pandas} -- \textsc{Scikit-learn} -- \textsc{Tensorflow} -- \textsc{Keras} -- \textsc{Matplotlib} -- \textsc{Spark Hadoop} -- \textsc{Git} -- \textsc{Office} -- \LaTeX -- \textsc{MATLAB} -- \textsc{HTML} -- \textsc{CSS}
