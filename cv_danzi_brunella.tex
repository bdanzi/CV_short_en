...
\tikzset{
  linkedinlogo/.pic={
    \fill[linkedinblue] svg{M17.67,0H1.073C0.483,0,0,0.483,0,1.073v14.157c0,0.589,0.483,1.072,1.073,1.072H17.67c0.589,0,1.073-0.483,1.073-1.072V1.073C18.743,0.483,18.259,0,17.67,0zM6.654,15.313H2.026V5.125h4.628V15.313zM4.34,3.475a1.531,1.531,0,1,1,1.531-1.531A1.53,1.53,0,0,1,4.34,3.475zm11.625,11.838h-4.63V9.51c0-1.095-0.022-2.5-1.525-2.5-1.527,0-1.76,1.192-1.76,2.428v4.906H7.583V5.125h4.613v1.292h0.065c0.642-1.153,2.214-2.375,4.549-2.375,4.875,0,5.771,3.206,5.771,7.382V15.313z};
  }
}
...
\textbf{Career goals:} I am a Ph.D. student at University and INFN of Bari in Experimental Particle Physics, and a Doctoral Student Semi-Fellow at CERN starting from March 2023. My major research interest concerns the double Higgs boson searches with the CMS experiment, coming from my Master's thesis studies. I mostly work with data analysis and data science tools, together with computer programming algorithms, in order to extract physics results from data, such as constraints on the Higgs boson self-couplings. I am also fascinated by gaseous detector technologies development, as it demostrates my Micropattern Gaseous Detector prototype studies during the 3-months INFN internship at CERN, and especially beam tests data-taking as my talks about beam test results show. After my Ph.D. in Physics, I would like to apply for a Data Analyst position to contribute further to the research business. The high academic standing, combined with the incredible experience during my Master's studies, inspired me to apply for job offers in worldwide prestigious companies which are fertile ground for collaborative and forward-thinking ideas such as Eni.\\
...
\textbf{Chair of two sessions in the \textit{Large Hadron Collider (LHC) Job Matching Event Spring '23 Moderator}. (\textit{3 May 2023}).}\\ 
The \href{https://indico.cern.ch/event/1269746/}{JMEv} is organized by a team of volunteers, members of the LHC Early Career Scientists Fora, which comprises the ALICE Junior Representatives, ATLAS Early Career Scientist Board, CMS Young Scientists Committee and the LHCb Early Career, Gender and Diversity Office. 
