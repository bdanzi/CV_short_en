...
\textbf{Machine learning/Higgs tagging.} Development of a mass-decorrelated deep neural network tagger for identifiying Higgs bosons decaying to four charged leptons (4mu,4e,2e2mu) inside and outside of CMS (\textit{2021--Present}).
