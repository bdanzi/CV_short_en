...
\href{https://www.uniba.it/en}{University of Bari \textit{Aldo Moro}} and \href{https://www.ba.infn.it/it/}{INFN Bari}\\
%Via Orabona, 4\\
%70125, Bari (BA), Italy
}
...
\textbf{Grade:} 110 with honors [\href{https://drive.google.com/file/d/1aV1ERPqgSpQ-9SRbWIpw-Q4BkuS1kvyy/view?usp=share_link}{Transcripts}]\\
...
\textbf{Grade:} 110 with honors [\href{https://drive.google.com/file/d/1V2sxudg9bGwW-S0WduNndtO60tdJLPUf/view?usp=sharing}{Transcripts}]\\
\textbf{Advisor:} Prof. Nicola De Filippis (Polytechnic and INFN Bari)
...
\textbf{Grade:} 110 with honors [\href{https://drive.google.com/file/d/13qAI0iYuqlVBQinnvZXv1eGDBE0ShnbM/view?usp=sharing}{Transcripts}]
...
Only person looking at each CMS sub-detectors physics quantities summary plots.

\textbf{Qualification task for the CMS Collaboration: Tracking efficiency Measurements using the Tag and Probe technique (\textit{April 2022--June 2022})}\\
A new framework has been implementated for the computation and in the Early Run 3 data misalignment and miscalibration effects has been spotted in high $\eta$ muon regions.
...
Tutor to 6 INFN members/associates in the \href{https://agenda.infn.it/event/28565/contributions/148551/}{Second Second Machine Learning INFN hackathon} proposing Higgs searches at the LHC exercise using simulated samples scaled to the Run II CMS integrated luminosities.
