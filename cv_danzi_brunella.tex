...
\textbf{108th National Congress of the Società Italiana di Fisica (SIF2022) in HEP Parallel session} \textbf{(\textit{13th September 2022})}\\ 
...
\textbf{15th Pisa Meeting on Advanced Detectors Edition 2022 in Poster session} \textbf{(\textit{27th May 2022})}\\ 
...
\textbf{{20th International Workshop on Advanced Computing and Analysis Techniques in Physics Research (ACAT2021) in Poster session and Lightning talks session for Posters Awards} } \textbf{(\textit{3rd December 2021})}\\ 
