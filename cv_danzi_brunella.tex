...
\textbf{CERN Doctoral Student: search for non-resonant production of double Higgs bosons decaying into muon pairs and two b-jets in pp collisions with the CMS experiment at the LHC (\textit{March 2023--Present}) | CERN}\\
...
\textbf{CERN Doctoral Student: Autotuning and Cellular Automaton extension to CMS strip detector (\textit{March 2023--Present}) | CERN}\\
...
\textbf{Tracking efficiency performance evaluation using the data-driven Tag and Probe technique (\textit{April 2021--Present}) | CERN}\\
