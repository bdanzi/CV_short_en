...
Tutor in the \href{https://agenda.infn.it/event/28565/contributions/148551/}{Second Second Machine Learning INFN hackathon} for six INFN members/associates for an use-case exercise concerning Higgs searches at the LHC experiment with simulated samples scaled to the Run II CMS integrated luminosities.\\
...
\href{https://dottorato.fisica.uniba.it}{University of Bari Ph.D. Fellowship and INFN Membership Association} \textbf{(\textit{2021--Present})}\\
...
\textbf{Machine learning/Higgs tagging.} Development of a mass-decorrelated deep neural network tagger for identifying Higgs bosons decaying to four charged leptons (4mu,4e,2e2mu) inside and outside of the CMS experiment (\textit{2021--Present}).\\
