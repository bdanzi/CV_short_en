...
\textsc{C/C++} -- \textsc{python} -- \LaTeX, \textsc{ROOT} -- \textsc{RooFit}
\MarginText{Scientific libraries} 
\textsc{numpy} -- \textsc{pandas} -- \textsc{scikit-learn} -- \textsc{tensorflow} -- \textsc{matplotlib}
\MarginText{Operating Systems} 
\textsc{OSX} -- \textsc{Windows}
