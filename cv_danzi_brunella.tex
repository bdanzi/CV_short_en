...
\Description{Programming Languages\ \ $\cdotp$\ \ \textsc{C/C++}, \textsc{python}, \LaTeX, \textsc{ROOT}, \textsc{RooFit}}
\Description{Scientific libraries \ \ $\cdotp$\ \ \textsc{numpy}, \textsc{pandas}, \textsc{scikit-learn}, \textsc{tensorflow}, \textsc{matplotlib}}
\Description{Operating Systems\ \ $\cdotp$\ \ \textsc{OSX}, \textsc{Windows}}
...
\Description{\MarginText{Driving Licence}\textsc{Category B}}

% \vspace{.5em} % Negative vertical space to counteract the vertical space between every \Description command

% %------------------------------------------------

\Description{\MarginText{Interests} Reading \ \ $\cdotp$\ \ Violin \ \ $\cdotp$\ \ Piano \ \ $\cdotp$\ \ Viola}
