...
\textbf{Higgs at CMS_Italia Workshop, Talk.} \textbf{(\textit{12th May 2022})}\\ 
...
\textbf{Second ML\_INFN hackathon - Starting level, Tutor and use-case presenter} \textbf{(\textit{15 December 2021})}\\ 
...
\textbf{2021 ACAT Workshop, Lightning talks session for Posters Awards.} \textbf{(\textit{3 December 2021})}\\ 
