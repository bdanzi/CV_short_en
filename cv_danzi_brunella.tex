...
\textbf{Position and Grade:}  in Violin, 110/110 with honors \href{https://drive.google.com/file/d/1aV1ERPqgSpQ-9SRbWIpw-Q4BkuS1kvyy/view?usp=share_link}{Transcripts}\\
...
\textbf{Positions and Grades:} M.Sc. in Nuclear, Subnuclear and Astroparticle Physics, B.Sc. in Physics, 110/110 with honors\\
...
Development of autotuning techniques for optimizing geometrical cuts to apply on Heterogenues Architectures (GPU,CPU)-based tracking algorithms at CMS experiment. \href{https://github.com/bdanzi/CA-parameter-tuning}{Multi-Objective Particle Swarm Optimization (MOPSO)} techique is currently applied with a fake rate tracks reduction of 40\%.
I am currently perfoming statistial analysis using supervised Machine Learning algorithms to increase the sensitivity to double Higgs signal signatures and using the state-of-the-art tagging Deep Learning technologies (\href{https://cms-ml.github.io/documentation/inference/particlenet.html}{ParticleNet}) for a better b-jets identification.
...
A new framework has been developed to speed up the computation during fitting procedcures on each physics quantities histogram bins using Apache Spark, and, in Early Run 3 data, misalignment and miscalibration effects has been spotted in high pseudorapidity ($\eta$) muon system regions.
