...
\textbf{{20th International Workshop on Advanced Computing and Analysis Techniques in Physics Research (ACAT2021), Poster session and Lightning talks session for Posters Awards} } \textbf{(\textit{3rd December 2021})}\\ 
